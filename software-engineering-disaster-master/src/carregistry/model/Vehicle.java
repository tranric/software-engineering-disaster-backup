...
public class Vehicle {
	...
	public String toString() {
		return "Vehicle [id=" + id + ", make=" + make + ", model=" + model + ", bodyStyle=" + bodyStyle + ", modelType="
				+ modelType + ", diesel=" + diesel + ", weight=" + weight + ", cost=" + cost + ", year=" + year
				+ ", passengers=" + passengers + ", details=" + details + ", owner=" + owner + "]";
	}
